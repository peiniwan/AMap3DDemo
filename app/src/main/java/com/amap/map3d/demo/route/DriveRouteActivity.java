...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		RecyclerView rvStrategy = (RecyclerView) findViewById(R.id.rvStrategy);
		GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 3);
		rvStrategy.setLayoutManager(gridLayoutManager);


		init();
		setfromandtoMarker();
		searchRouteResult(ROUTE_TYPE_DRIVE, RouteSearch.DrivingSaveMoney);
	}
